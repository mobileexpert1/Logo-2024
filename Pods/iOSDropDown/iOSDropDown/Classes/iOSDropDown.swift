...
open class DropDown: UITextField {
    ...
    @IBInspectable public var selectedRowColor: UIColor = UIColor(red: 0/255, green: 134/255, blue: 232/255, alpha: 1.0)
    ...
    @IBInspectable public var arrowSize: CGFloat = 0 {
        didSet {
    ...
    func setupUI() {
        ...
        arrow = Arrow(origin: CGPoint(x: center.x - arrowSize / 2 - 30, y: center.y - arrowSize / 2), size: arrowSize)
